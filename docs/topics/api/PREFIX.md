...
<code-block lang="php">
<![CDATA[constant string PREFIX = \PHP_PREFIX]]>
</code-block>
...
<p><format style="italic">On Windows, it is the value --with-prefix was set to at configure-</format></p>
...
<deflist><def title="Fully Qualified Constant Name:">
        \FireHub\Core\Support\Constants\Path\PREFIX
    </def><def title="Source code:">
        <a href="https://github.com/The-FireHub-Project/Core/blob/develop-pre-alpha-m1/src/support/constants/path.php#L124">
            View source code
        </a>
    </def>
    <def title="Blame:">
