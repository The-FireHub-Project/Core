...
readonly class Split {
     ...
     *
     * @param \FireHub\Core\Support\DataStructures\Contracts\Chunkable<TKey, TValue>&\FireHub\Core\Support\DataStructures\Contracts\Filterable<TKey, TValue> $data_structure <p>
