...
<code-block lang="php">
<![CDATA[constant string DATADIR = \PHP_DATADIR]]>
</code-block>
...
<deflist><def title="Fully Qualified Constant Name:">
        \FireHub\Core\Support\Constants\Path\DATADIR
    </def><def title="Source code:">
        <a href="https://github.com/The-FireHub-Project/Core/blob/develop-pre-alpha-m1/src/support/constants/path.php#L166">
            View source code
        </a>
    </def>
    <def title="Blame:">
