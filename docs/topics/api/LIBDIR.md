...
<code-block lang="php">
<![CDATA[constant string LIBDIR = \PHP_LIBDIR]]>
</code-block>
...
<deflist><def title="Fully Qualified Constant Name:">
        \FireHub\Core\Support\Constants\Path\LIBDIR
    </def><def title="Source code:">
        <a href="https://github.com/The-FireHub-Project/Core/blob/develop-pre-alpha-m1/src/support/constants/path.php#L156">
            View source code
        </a>
    </def>
    <def title="Blame:">
