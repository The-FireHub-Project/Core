...
class Obj extends Collection {
     ...
     * an array.
     *
     * @return array<array{key: TObject, value: TInfo}> Data which can be serialized by json_encode(), which is a value
     ...
     * an array.
     *
     * @return array<array{key: TObject, value: TInfo}> An associative array of key/value pairs that represent
     ...
     * @since 1.0.0
     *
     * @param array<array{key: TObject, value: TInfo}> $data <p>
     * Serialized data.
     * </p>
     *
