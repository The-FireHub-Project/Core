<title># SYSCONFDIR</title>

<code-block lang="php">
<![CDATA[constant string SYSCONFDIR = \PHP_SYSCONFDIR]]>
</code-block>
...
<deflist><def title="Fully Qualified Constant Name:">
        \FireHub\Core\Support\Constants\Path\SYSCONFDIR
    </def><def title="Source code:">
        <a href="https://github.com/The-FireHub-Project/Core/blob/develop-pre-alpha-m1/src/support/constants/path.php#L176">
            View source code
        </a>
    </def>
    <def title="Blame:">
