...
class Associative extends ArrStorage implements Arrayable, KeyChangeable, KeySortable, Overloadable {
     ...
     * $collection = new Associative(['firstname' => 'John', 'lastname' => 'Doe', 'age' => 25, 10 => 2]);
     *
     * $collection->reverse($collection2);
     *
    ...
    public function reverse ():static {
        ...
        $this->storage = Arr::reverse($this->storage, true);
    ...
    /**
     * ### Create a new data structure with keys and values that are not appearing in the other data structure
     * @since 1.0.0
     *
    ...
    /**
     * ### Create a new data structure with keys that are not appearing in the other data structure
     * @since 1.0.0
     *
    ...
    /**
     * ### Create a new data structure with keys and values that are appearing in all data structures
     * @since 1.0.0
     *
     * @uses \FireHub\Core\Support\LowLevel\DataIs::callable() To check if $value parameter is provided.
    ...
    /**
     * ### Create a new data structure with keys appearing in all data structure
     * @since 1.0.0
     *
    ...
    /**
     * ### Create a new data structure with keys and values appearing in any data structure but not all
     * @since 1.0.0
     *
    ...
    public function sort (Order $order = Order::ASC, Sort $flag = Sort::BY_REGULAR):static {
        ...
        Arr::sort($this->storage, $order, $flag, true);
    ...
    public function sortKeys (Order $order = Order::ASC, Sort $flag = Sort::BY_REGULAR):static {
        ...
        Arr::sortByKeys($this->storage, $order, $flag);
    ...
    public function sortKeysBy (callable $callback):static {
        ...
        Arr::sortKeysBy($this->storage, $callback);
