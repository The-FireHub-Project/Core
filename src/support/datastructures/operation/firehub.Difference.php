...
/**
 * ### Create a new data structure with keys or values that are not appearing in the other data structure
 * @since 1.0.0
 *
 * @template TDataStructure of \FireHub\Core\Support\DataStructures\Contracts\Filterable
 */
readonly class Difference {
     ...
     * ```
     *
     * @param \FireHub\Core\Support\Contracts\HighLevel\DataStructures<covariant mixed, covariant mixed> $data_structure <p>
     * Data structure to provide set operator.
     * </p>
     *
     * @return TDataStructure New filtered data structure.
     */
    ...
    /**
     * ### Create a new data structure with values that are not appearing in the other data structure
     * @since 1.0.0
     *
     * @uses \FireHub\Core\Support\DataStructures\Contracts\Filterable::filter() To filter items from the data structure.
     * @uses \FireHub\Core\Support\Contracts\HighLevel\DataStructures::contains() To determine whether a data structure
