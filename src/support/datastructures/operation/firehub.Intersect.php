...
/**
 * ### Create a new data structure with keys or values appearing in all data structures
 * @since 1.0.0
 *
...
readonly class Intersect {
    ...
    /**
     * ### Create a new data structure with keys appearing in all data structures
     * @since 1.0.0
     *
    ...
    /**
     * ### Create a new data structure with keys and values appearing in all data structures
     * @since 1.0.0s
     *
     * @uses \FireHub\Core\Support\DataStructures\Contracts\Filterable::filter() To filter items from the data structure.
     * @uses \FireHub\Core\Support\Contracts\HighLevel\DataStructures::contains() To determine whether a data structure
