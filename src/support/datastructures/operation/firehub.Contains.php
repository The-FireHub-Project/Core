...
readonly class Contains {
    ...
    public function key (mixed $search):bool {
        ...
        if ($this->data_structure instanceof ArrayableStorage && (DataIs::int($search) || DataIs::string($search)))
     ...
     * @since 1.0.0
     *
     * @uses \FireHub\Core\Support\LowLevel\Data::getType() To get current value type.
     * @uses \FireHub\Core\Support\DataStructures\Operation\Contains::where() To check if a value exists
     * in data structure.
     *
     * @example
