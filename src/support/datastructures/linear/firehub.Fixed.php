 ...
 * @api
 */
class Fixed extends SplFixedArray implements FixedContract, Reversible {
     ...
     * @since 1.0.0
     *
     * @uses \FireHub\Core\Support\Contracts\HighLevel\DataStructures::count() To get number of elements in the provided
     * data structure.
     */
