<title># EndingPunctuation</title>

<code-block lang="php">
<![CDATA[enum EndingPunctuation]]>
</code-block>
...
<deflist><def title="Fully Qualified Enum Name:">
    ...
    <def title="Blame:">
        <a href="https://github.com/The-FireHub-Project/Core/blame/develop-pre-alpha-m1/src/support/enums/string/firehub.EndingPunctuation.php">
            View blame
        </a>
    </def>
    <def title="History:">
        <a href="https://github.com/The-FireHub-Project/Core/commits/develop-pre-alpha-m1/src/support/enums/string/firehub.EndingPunctuation.php">
            View history
        </a>
    </def></deflist>
### Changelog
...
## case: EXCLAMATION {id="exclamation"}
