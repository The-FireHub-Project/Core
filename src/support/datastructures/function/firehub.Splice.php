...
readonly class Splice {
     ...
     * </p>
     *
     * @return TDataStructure New spliced data structure.
     */
    public function __invoke (int $offset, ?int $length = null):Filterable {

        if ($this->data_structure instanceof ArrStorage && $this->data_structure instanceof Sequantionable) {
