...
<code-block lang="php">
<![CDATA[constant string BINDIR = \PHP_BINDIR]]>
</code-block>
...
<p><format style="italic">On Windows, it is the value --with-prefix was set to at configuring.</format></p>
...
<deflist><def title="Fully Qualified Constant Name:">
        \FireHub\Core\Support\Constants\Path\BINDIR
    </def><def title="Source code:">
        <a href="https://github.com/The-FireHub-Project/Core/blob/develop-pre-alpha-m1/src/support/constants/path.php#L136">
            View source code
        </a>
    </def>
    <def title="Blame:">
