 ...
 * @since 1.0.0
 *
 * @template TDataStructure of \FireHub\Core\Support\Contracts\HighLevel\DataStructures\Linear
 */
readonly class Reduce {
     ...
     *
     * @param callable(mixed, value-of<TDataStructure>):mixed $callback <p>
