<title># FLOAT_MIN</title>

<code-block lang="php">
<![CDATA[constant float FLOAT_MIN = \PHP_FLOAT_MIN]]>
</code-block>
...
<deflist><def title="Fully Qualified Constant Name:">
        \FireHub\Core\Support\Constants\Number\FLOAT_MIN
    </def><def title="Source code:">
        <a href="https://github.com/The-FireHub-Project/Core/blob/develop-pre-alpha-m1/src/support/constants/number.php#L89">
            View source code
        </a>
    </def>
    <def title="Blame:">
