...
trait Jsonable {
     ...
     * @uses \FireHub\Core\Support\LowLevel\DataIs::array() To check if a decoded JSON string is an array.
     *
     * @param string $json <p>
    ...
    /**
     * ### jsonSerialize magic method
     * @since 1.0.0
     */
    abstract public function jsonSerialize ():array;

    /**
     * ### Method to create an object from an array
     * @since 1.0.0
     */
